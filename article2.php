...
<section class="ddle">
        <div class="content grid grid-pad">
                    <div class="titrearticle col-9-12">
                              ...
                              <h5 class="col-3-12">Zo - 06 Février 2015</h5><p class="push-right" style="font-size:0.5em;"><span class="fa-stack fa-lg"><a style="color:#000;" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.gaming-gen.fr&t=" title="Partagez notre article sur facebook" target="_blank" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(document.URL) + '&t=' + encodeURIComponent(document.URL)); return false;"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-facebook fa-inverse fa-stack-1x"></i></a></span><span class="fa-stack fa-lg"><a style="color:#000;" href="https://twitter.com/intent/tweet?source=http%3A%2F%2Fwww.gaming-gen.fr&text=:%20http%3A%2F%2Fwww.gaming-gen.fr" target="_blank" title="Tweet" onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent(document.title) + ':%20'  + encodeURIComponent(document.URL)); return false;"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-twitter fa-inverse fa-stack-1x"></i></a></span></p>
                              
                              </span>
                               <hr class="sepanews"/><br/>
                               <span class="col-9-12">
                               <h3>3 jours de jeux, 3 jours d’émotions, 3 jours de rencontres et de découvertes...<br/><br/> 

L’association Gaming Generation est fière de vous annoncer que la 4ème édition de son grand festival du jeu, la Gaming Gen, aura lieu à la Halle de Gardanne (13120), du 15 au 17 mai 2015. <br/><br/>

La GG4 s’articule autour de deux univers aussi distincts que liés :<br/>
=> Numérique - Une partie de la salle intéressera particulièrement les gamers avertis, avec différents tournois (CS Global Offensive, FIFA…) en plus des espaces dédiés au retro-gaming et aux jeux musicaux. <br/>
---> 200 joueurs attendus. <br/>
=> Ludique - En parallèle, une quinzaine d’animations gratuites seront proposées aux visiteurs : des jeux de sociétés au babyfoot, en passant par les jeux de rôlistes, le coin ludothèque pour les plus petits et bien d’autre surprises… <br/>
---> 3 000 visiteurs attendus.<br/><br/>

Contacts <br/>
Pour plus d’informations, n’hésitez pas à visiter notre page Facebook ou notre site web www.gaming-gen.fr et à nous envoyer un e-mail sur contact@gaming-gen.fr. <br/><br/>
Notre leitmotiv <br/>
La Gaming Gen 4 et le Festival du Jeu de Gardanne rassemblent les individus dans un seul but : l’émotion, celle du Jeu.
A toutes les époques, aussi loin que l’histoire de l’humanité remonte ; en temps de paix ou de crise économique, militaire, sociale ; avec des nouvelles technologies ou des moyens rudimentaires ; pour s’éveiller, se divertir, pour socialiser, sympathiser, pour participer, pour gagner… Le Jeu est dans nos gènes. <br/><br/><br/>
