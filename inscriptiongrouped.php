...
<section class="ddle">
        <div class="content grid grid-pad">
                    <div class="titrearticle col-9-12">
                                <h1><span>INSCRIPTION GROUP&Eacute;E</span></h1>
                    </div><!--titrearticle-->
                   			 <div class="articletxt col-9-12">
                              
                                          
                                            <h4>Si votre équipe est complète et que vous souhaitez l'inscrire directement, c'est ici que ça se passe! Le paiement de 666 euros sera à régler par la suite afin que nos équipes valident la présence de votre équipe.</h4><br/>
...
<br/>
                            		...
                            		<form action="inscriptiongroupe.php" class="formulaireinsgroupee">
                                    <label for="civil">Civilité</label><SELECT id="civil" name="Civil" size="1">
                                    <OPTION>Madame
                                    <OPTION>Monsieur
                                    </SELECT>
                                    <label for="name">Nom et Prénom*</label><input id="name" name="name" type="text" required>
                                    <label for="team">Equipe*</label><input  id="team" name="team" type="text" required>
                                    ...
                                    <label for="resamonitor">Réserver des écrans</label><input  id="team" name="team" type="text" required>
                                    
                                    <div class="blockparent"><span class="autorisationparentale"><p>Si il y a des mineurs dans votre équipe, présenter l'autorisation parentale !</p></span><a href="Gaming-gen4-AutorisationParentale-Mineur.pdf"><span class="fa fa-download downloadorange"></span></a></div><br/><br/>
                                    <div class="grid infosgen">
                                        <span class="fa-stack fa-lg">
                                        <i class="fa fa-circle fa-stack-2x" style="color:#93C;"></i>
                                        <i class="fa fa-crosshairs fa-stack-1x fa-inverse"></i>
                                        </span>
                                        Joueur 1<hr class="titrehrins col-9-12" style="float:right;"/></div>
                                    ...
                                    <label for="licence">Licence masters</label><input id="licence" name="licence" type="text"><br/>
                                    
                                    <div class="grid infosgen">
                                    <a href="#">
                                        <span class="fa-stack fa-lg">
                                        <i class="fa fa-circle fa-stack-2x" style="color:#7EB400;"></i>
                                        <i class="fa fa-plus fa-stack-1x fa-inverse"></i>
                                        </span>
                                        Ajouter un joueur</a></div><br/>
