        ...
        <div class="content grid grid-pad">
                    <div class="titrearticle col-9-12">
                   			 ...
                   			 <div class="articletxt col-9-12">
                                    ...
                                    <br/>
                                    <h4>Voilà ma courte description :<br/>1er ESWC FR<br/>1er Pxl-lan<br/>Alors salut! </h4>
                                    </div>
                             ...
                             <div class="hotfix col-3-12">
                                                 ...
                                                 <div class="moninscription">
                                                     	<h6><span class="fa fa-file-text"></span>&nbsp;&nbsp;INSCRIPTION</h6>
                                                             ...
                                                             <h4>Pour t'inscrire, cliques ici :</h4>
                                                             <button onclick="window.location.replace('inscription.php');" class="buttoninscription btn btn-5vio btn-5viob icon-star">
